...
# PROMPT: Write a retail CCTV detection pipeline using YOLOv8n and ByteTrack
# that processes 5 camera feeds and emits structured events per the schema.
# CHANGES MADE: Used SKIP=5 for CPU speed, per-camera tracker instances,
# save-to-Drive after each camera to prevent data loss on runtime reset,
# direction detection via Y-position delta over 10 frames.
"""
import sys
import os
